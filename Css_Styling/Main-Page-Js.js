			...
			document.addEventListener("mousemove",function(e){
				...
				function change(){
					var title1=document.getElementById("mychange");
				...
				function change1(){
					var title2=document.getElementById("mychange").src="Images\\Technology.jpg";
				    var gettitle=document.getElementById("flex-title-display");
				...
				function change3(){
					var title4=document.getElementById("mychange").src="Images\\Travel.jpg";
				    var gettitle=document.getElementById("flex-title-display");
				...
				function change4(){
					var title5=document.getElementById("mychange").src="Images\\Hospitality.jpg";
				    var gettitle=document.getElementById("flex-title-display");
				...
				function change5(){
					var title6=document.getElementById("mychange").src="Images\\Introspection.jpg";
				    var gettitle=document.getElementById("flex-title-display");
